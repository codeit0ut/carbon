...
export default function InspectionDocumentEditor({
  ...
  const loadAnnotations = useCallback(async () => {
    try {
      const response = await fetch(
        `${path.to.inspectionDocument(diagramId)}/annotation/get`
      );
  ...
  const persistAnnotationResize = useCallback(
    async (annotation: AnnotationRecord) => {
      ...
      try {
        const response = await fetch(
          `${path.to.inspectionDocument(diagramId)}/annotation/update`,
  ...
  const handleCreateAnnotation = useCallback(async () => {
    ...
    try {
      const response = await fetch(
        `${path.to.inspectionDocument(diagramId)}/annotation/create`,
        {
          method: "POST",
          body: formData
        }
  ...
  const handleDeleteAnnotation = useCallback(async () => {
    ...
    try {
      const response = await fetch(
        `${path.to.inspectionDocument(diagramId)}/annotation/delete`,
        {
          method: "POST",
          body: formData
        }
